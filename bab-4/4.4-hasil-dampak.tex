...
\begin{itemize}
    ...
    Waktu yang dibutuhkan untuk memuat halaman rekap data pada sistem lama dapat mencapai ±120 detik (2 menit) karena seluruh data dimuat secara serentak. Pada sistem MonPD Reborn yang telah dikembangkan, dengan menerapkan teknik asynchronous loading (AJAX) dan server-side paging, waktu muat rata-rata berhasil direduksi secara drastis menjadi hanya ±3–5 detik.
