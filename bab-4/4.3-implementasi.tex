...
\begin{enumerate}
    ...
    Penjelasan Kode 4.1: Kode ini mendefinisikan hubungan antara properti di dalam kode aplikasi dengan kolom fisik di \emph{database} Bapenda. Penggunaan atribut \texttt{[Table("T\_PEMERIKSAAN")]} dan \texttt{[Column]} memastikan bahwa EF Core dapat melakukan kueri secara akurat ke tabel yang telah dioptimalkan oleh tim \emph{database} Bapenda. Properti dengan tipe data \emph{nullable} seperti \texttt{decimal?} pada \texttt{Jumlah\_Kb} digunakan untuk menangani kemungkinan data kosong di \emph{database} tanpa menyebabkan \emph{system crash}.
...
\begin{itemize}
    ...
    \begin{figure}[H]
        ...
        \small{Sumber: Dokumentasi Sistem}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.54\textwidth]{gambar/dashboard-menu-monpd.png}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.97\textwidth]{gambar/datagrid.png}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.65\textwidth]{gambar/popup-detail.png}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.74\textwidth]{gambar/geospasial.png}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.91\textwidth]{gambar/realisasi-pajak.png}
