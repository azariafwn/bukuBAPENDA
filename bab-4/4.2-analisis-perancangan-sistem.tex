...
\begin{itemize}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.9\textwidth]{gambar/wireframe/wireframe-dashboard-utama-monpd.png}
        \caption{\emph{Wireframe Dashboard} Utama MonPD Reborn}
        \small{Sumber: Olahan Penulis}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.65\textwidth]{gambar/wireframe/wireframe-dashboard-menu-monpd.png}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.93\textwidth]{gambar/wireframe/wireframe-datagrid.png}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.73\textwidth]{gambar/wireframe/wireframe-geospasial.png}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.76\textwidth]{gambar/wireframe/wireframe-realisasi-pajak.png}
