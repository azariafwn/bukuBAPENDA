...
\begin{itemize}
    ...
    \end{figure}
    \begin{itemize}
        \item \textbf{Fitur:} Pencarian nama objek pajak, filter wilayah (UPTB), filter jenis pajak secara spesifik, dan area pemetaan titik lokasi.
        \item \textbf{Analisis Penempatan:} 
            \begin{itemize}
                \item Filter Wilayah dan Nama Objek Pajak (\emph{yellow box}): Diletakkan di bagian atas panel kendali untuk memudahkan pengguna mempersempit pencarian lokasi berdasarkan nama spesifik atau wilayah kerja UPTB tertentu.
                \item Filter Jenis Pajak (\emph{green box}): Penempatan daftar pilihan jenis pajak secara vertikal memungkinkan pengguna untuk melakukan \emph{plotting} multi-sektor sekaligus atau fokus pada satu kategori pajak saja guna melihat kepadatan sebaran secara visual.
                \item Titik Lokasi Objek Pajak (\emph{blue box}): Area peta diletakkan sebagai elemen visual utama yang paling luas. Penempatan ini memudahkan tim lapangan dalam merencanakan rute pengawasan secara efektif berdasarkan konsentrasi sebaran titik-titik objek pajak yang muncul setelah parameter filter diterapkan.
            \end{itemize}
    \end{itemize}
